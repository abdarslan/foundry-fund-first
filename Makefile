...
deploy-sepolia:
	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url ${SEPOLIA_RPC_URL} --account sepoliaKey --sender 0xe6a386de7d13c9be8d85e0382d6bbd45f760fcb0 --broadcast --verify --etherscan-api-key ${ETHERSCAN_API_KEY} -vvvv
